...
void WeatherManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->weatherReady((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (WeatherManager::*)(const QString & )>(_a, &WeatherManager::weatherReady, 0))
            return;
    }
}
...
// SIGNAL 0
void WeatherManager::weatherReady(const QString & _t1)
{
